...
1. **Set up the database:** Open SQL Server Management Studio (SSMS) or Azure Data Studio and execute the `01_create_and_seed_clinic.sql` script. This will create the `ClinicAdoNet` database and fill it with sample data.
